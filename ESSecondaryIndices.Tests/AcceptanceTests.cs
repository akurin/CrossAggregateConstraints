...
using ESSecondaryIndices.Application;
using ESSecondaryIndices.Domain;
using ESSecondaryIndices.Ports.Costraints;
using ESSecondaryIndices.Ports.Persistance;
using ESSecondaryIndices.Ports.Persistance.EventDispatching;
using ESSecondaryIndices.Ports.Persistance.Repositories;
using ESSecondaryIndices.Tests.Ports;
using ESSecondaryIndices.Tests.Ports.Persistance;
...
namespace ESSecondaryIndices.Tests
{
    [TestFixture]
